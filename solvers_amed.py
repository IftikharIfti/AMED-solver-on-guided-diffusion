...
def init_hook(net, class_labels=None):
    ...
    elif net.img_resolution == 256:  ##NR: what will happen for other res                                       # models from CM and ADM with resolution of 256
...
def amed_sampler(
    net, latents, class_labels=None, condition=None, unconditional_condition=None,
    num_steps=None, sigma_min=0.002, sigma_max=80, schedule_type='polynomial',
    schedule_rho=7, afs=False, denoise_to_zero=False, return_inters=False,
    AMED_predictor=None, step_idx=None, train=False, **kwargs
):
