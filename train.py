...
@click.command()
@click.option('--dataset_name', help='Dataset name', metavar='STR', type=click.Choice(['imagenet64', 'imagenet256', 'ms_coco']), required=True)
...
@click.option('--guidance_type', help='Guidance type', type=click.Choice(['cg', 'cfg', 'uncond']), default='uncond', show_default=True)
@click.option('--guidance_rate', help='Guidance rate', metavar='FLOAT', type=float, default=0.)
# [Other options remain unchanged]                            type=float, default=0.)
